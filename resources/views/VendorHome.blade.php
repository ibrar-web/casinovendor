...
<body ng-app="myApp">
    ...
    <script src="<?= asset('Vendorjs/routes.js') ?>"></script>
    <script src="<?= asset('Vendorjs/VendorHome.js') ?>"></script>
    <script src="<?= asset('Vendorjs/TransctionHistory.js') ?>"></script>
    <script src="<?= asset('Vendorjs/AccountHistory.js') ?>"></script>
    <script src="<?= asset('Vendorjs/AccountReport.js') ?>"></script>
