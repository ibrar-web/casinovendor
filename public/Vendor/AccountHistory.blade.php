        ...
        <div class="data-table">
            ...
            <table class="table" style="width: 100%">
                ...
                <tbody>
                    <tr ng-repeat="(key,item) in pagedItems[currentPage]| filter:test" ng-class="{1:'bet', 2:'reward', 3:'cancel',4:'deposit',5:'bonus',6:'redeem','7':'wintod'}[item.color]">
                        ...
                        <td class="name"><%item.amount%></td>
                        <td class="name"><%item.description%></td>
                        <th class="name"><%item.frombalance%>/<%item.tobalance%></th>
            ...
            <div class="tablenew">
                ...
                <div class="tablebody" ng-repeat="(key,item) in pagedItems[currentPage] | filter:test" >
                    <div class="tablebody1" ng-class="{1:'bet', 2:'reward', 3:'cancel',4:'deposit',5:'bonus',6:'redeem','7':'wintod'}[item.color]">
                        <div class="user-id">
                            <span ng-click="copyToClipboard(item.username);"><%item.account%></span>
                        </div>
                        <!--<i class="fas fa-copy"></i>-->
                        <div class="nameacc"><%item.name%></div>
                        <div class="nameacc" ><%item.amount%></div>
                        <div class="creditacc" ><%item.description%></div>
                    ...
                    <div class="tableaction" ng-if="!item.id">
                        <div class="nameacc">change:<%item.frombalance%>/<%item.tobalance%></div>
                        <div class="nameacc"><%item.created_at%></div>
                    </div>
                </div>
            </div>
            <div class="bodyview3">
