            ...
            <div class="tablenew">
                ...
                <div class="tablebody" ng-repeat="(key,item) in pagedItems[currentPage] | filter:test">
                    ...
                    <div class="tableaction" ng-if="!item.id">
                        ...
                        <div class="name">Profit:<%item.profit%></div>
                        <div class="name">Payout:<%item.payout%></div>
                    </div>
                </div>
                <div class="tablebody">
                    <div class="tablebody1">
                        ...
                        <div class="name"><%Redeems%></div>
                        <div class="credit"><%Bounceback%></div>
                        <div class="name"><%profit%></div>
                        <div class="names"><%payout%></div>
                    </div>
                </div>
            </div>
            <div class="bodyview3">
