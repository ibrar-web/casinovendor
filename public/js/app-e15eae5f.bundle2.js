...
window.app = function(t) {
                            ...
                            return regeneratorRuntime.wrap(function(t) {
                                ...
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 2:
                                        if (t.sent.data == true) {
                                            e = t.sent;
                                            this.isError = !0, this.errorMsg = e.data.errorMessageDisplay ? e.data.errorMessageDisplay : "Login Success", this.setFieldFocus()
                                            window.location.href = "http://localhost/Agamesnew/public/home";
                                            return t.stop()
                                        } else {
                                            e = t.sent;
    ...
    5758: function(t, e, n) {
        ...
        var s = function() { return o.get("/rest/player/bonuses/priority/") },
            ...
            f = function(t) { var e = t.accountID; return o.post(`http://localhost/Agamesnew/public/loginuser?account_id=${e}`, { account_id: e, brand_id: window.brandId }) },
            m = function(t) {
                var e = t.accountID,
                    n = t.password;
